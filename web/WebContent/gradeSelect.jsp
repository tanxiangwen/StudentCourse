				...
				<div id="mainRight">
					...
					<div>
								<table width="500" align="center" cellspacing="0">
									<tr><th colspan="2" height="40" bgcolor="tan">学生成绩查询结果</th></tr>		
									<tr>
										<td height="30" bgcolor="bisque">所选课程</td>
										<td height="30" bgcolor="wheat">成绩</td>
									</tr>

										<c:forEach items="${sessionScope.studentScores}" var="score">
											<c:if test="${score.grade!=0}" >
												<tr>
													<td height="30" bgcolor="wheat">${score.cName}</td>
													<td height="30" bgcolor="bisque">${score.grade}</td>
												</tr>
